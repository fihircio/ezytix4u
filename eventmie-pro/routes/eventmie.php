...
Route::group([
    ...
    /*Organiser events */
    Route::group(['prefix' => 'promocodes',], function () use ($namespace) {
        $controller = $namespace.'\PromocodesController';
    ...
    Route::prefix('/seatschart')->group(function () use ($namespace) {
        ...
        Route::post('/upload',"$controller@upload_seatchart")->name('eventmie.upload_seatchart');
